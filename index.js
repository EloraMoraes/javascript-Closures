(function(){
    ...
    const irParaDadosBtn = document.getElementById("irParaDadosBtn");
const dadosEntregaContainer = document.querySelector(".dados-entrega-container");
const carrinhoContainer = document.querySelector(".carrinho-container");


irParaDadosBtn.addEventListener("click", () => {
    window.location.href = "resumo-pedido.html";
    carrinhoContainer.style.display = "none";
    dadosEntregaContainer.style.display = "block";
});
